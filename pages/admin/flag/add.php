...
?>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y ">
            <h4 class="py-1 ms-3 mb-1"><span class="text-muted fw-light">Tambah</span> Bendera</h4>
                            ...
                            <form data-toggle="validator" action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" id="basic-icon-default-fullname" placeholder="Bendera" name="namaFlag" aria-label="Bendera" aria-describedby="basic-icon-default-fullname2" required />
                                    </div>
                                </div>
    ...
    if (isset($_POST['simpan'])) {
        ...
        $simpan = $link->query("INSERT INTO flag (namaFlag) VALUES ('$flag')");
        ...
        if ($simpan) {
            ...
            Swal.fire({
                ...
                window.location.href = '?page=tambah_flag'; 
            });
        </script>";
        }
    }
