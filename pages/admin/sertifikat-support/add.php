...
?>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y ">
            <h4 class="py-1 ms-3 mb-1"><span class="text-muted fw-light">Tambah</span> Sertifikat Support</h4>
            <div class="col-12 text-end mb-3">
                <a href="?page=data_sertSupport" class="btn btn-primary">Kembali</a>
            </div>
            <!-- Basic Layout -->
            <div class="row">
                <div class="col-xl">
    ...
    if (isset($_POST['simpan'])) {
        ...
        $stmt = $link->prepare("INSERT INTO sertifikat_support (idJenisSertifikat, idSupport, tglTerbit, tglExp, permanent,berkas) VALUES (?,?,?, ?, ?, ?)");
        if ($stmt) {
            $stmt->bind_param("iissis", $idJenisSertifikat, $idSupport, $tglTerbit, $tglExp, $permanent, $berkas);
        ...
        if ($simpan) {
            ...
            Swal.fire({
                ...
                window.location.href = '?page=tambah_sertSupp'; 
            });
        </script>";
        }
    }
