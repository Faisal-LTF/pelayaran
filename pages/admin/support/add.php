...
?>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y ">
            <h4 class="py-1 ms-3 mb-1"><span class="text-muted fw-light">Tambah</span> Support</h4>
    ...
    if (isset($_POST['simpan'])) {
        ...
        $simpan = $link->query("INSERT INTO support VALUES (
            '', 
            '$idJenisKapal',
            '$idJenisMesin',
            '$idFlag',
        ...
        if ($simpan) {
            ...
            Swal.fire({
                ...
                window.location.href = '?page=tambah_support'; 
            });
        </script>";
        }
    }
