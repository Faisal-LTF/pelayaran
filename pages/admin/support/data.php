        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = `?page=hapus_support&id=${id}`;
                }
            });
        }
    </script>
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-12 text-end mb-3">
                <a href="?page=tambah_support" class="btn btn-primary">Tambah Data</a>
            </div>
            <div class="card">
                <div class="card-datatable table-responsive pt-0">
                    <table id="example" class="table align-items-center">
                        ...
                        <tbody>
                            ...
                            $no = 1;
                            $query = mysqli_query($link, "SELECT s.*, jk.namaJenisKapal, jm.jenisMesin, f.namaFlag 
                            FROM support s
                            JOIN jenis_kapal jk ON s.idJenisKapal = jk.idJenisKapal
                            JOIN jenis_mesin jm ON s.idJenisMesin = jm.idJenisMesin
                            JOIN flag f ON s.idFlag = f.idFlag WHERE s.idJenisKapal = 7 ");
                            $i = 1;
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="w-5">
                                        <a class="badge btn-success" href="?page=detail_support&id=<?= $row[0]; ?>"><i class="fa fa-info-circle"></i>
                                            Detail</a></li>
                                    </td>
                                    <td class="w-5">
                                        <div class=" mt-3">
                                            ...
                                            <ul class="dropdown-menu shadow-lg mt-2  dropdown-menu-end px-2 py-2 me-sm-n4" role="menu">
                                                <li><a class="dropdown-item border-radius-md" href="?page=edit_support&id=<?= $row[0]; ?>"><i class="fa fa-edit"></i>
                                                        Edit Data</a></li>
