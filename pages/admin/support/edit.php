...
if (!isset($_SESSION['nama'])) {
    ...
    $id = $_GET['id'];
    $query = $link->query("SELECT s.*, jk.namaJenisKapal, jm.jenisMesin, f.namaFlag 
    FROM support s
    JOIN jenis_kapal jk ON s.idJenisKapal = jk.idJenisKapal
    JOIN jenis_mesin jm ON s.idJenisMesin = jm.idJenisMesin
    JOIN flag f ON s.idFlag = f.idFlag WHERE idSupport = '$id'");
...
?>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y ">
            ...
            <div class="col-12 text-end mb-3">
                <a href="?page=data_support" class="btn btn-primary">Kembali</a>
            </div>
            <!-- Basic Layout -->
            <div class="row">
                <div class="col-xl">
    ...
    if (isset($_POST['edit'])) {
        ...
        $edit = $link->query("UPDATE support SET 
...
WHERE idSupport = '$id'");
    ...
    Swal.fire({
        ...
        window.location.href = '?page=data_support'; 
    });
</script>";
        } else {
            echo "<script>
    Swal.fire({
        ...
        window.location.href = '?page=edit_support'; 
    });
</script>";
        }
    }
