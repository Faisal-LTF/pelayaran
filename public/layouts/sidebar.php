                    ...
                    <div class="layout-container">
                        ...
                        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                            ...
                            <ul class="menu-inner py-1">
                                ...
                                <li
                                    class="menu-item <?php if (isset($_GET['page']) && $_GET['page'] == 'public/dashboard.php') echo 'active'; ?>">
                                    <a href="home.php" class="menu-link">
                                        <i class="menu-icon tf-icons ti ti-smart-home"></i>
                                        <div data-i18n="Dashboard">Dashboard</div>
                                    </a>
                                ...
                                <li
                                    class="menu-item <?php if (isset($_GET['page']) && $_GET['page'] == 'data_user') echo 'active'; ?>">
                                    <a href="?page=data_user" class="menu-link">
                                        <i class="menu-icon tf-icons ti ti-smart-home"></i>
                                        <div data-i18n="Users">Users</div>
                                    </a>
                                ...
                                <li
                                    class="menu-item <?php if (isset($_GET['page']) && $_GET['page'] == 'data_pegawai') echo 'active'; ?>">
                                    <a href="?page=data_pegawai" class="menu-link">
                                        <i class="menu-icon tf-icons ti ti-smart-home"></i>
                                        <div data-i18n="Pegawai">Pegawai</div>
                                    </a>
                                </li>
                                <li
                                    class="menu-item <?php if (isset($_GET['page']) && $_GET['page'] == 'data_primer') echo 'active'; ?>">
                                    <a href="?page=data_primer" class="menu-link">
                                        <i class="menu-icon tf-icons ti ti-smart-home"></i>
                                        <div data-i18n="Prime">Prime</div>
                                    </a>
                                </li>
                                <li
                                    class="menu-item <?php if (isset($_GET['page']) && $_GET['page'] == 'data_secunder') echo 'active'; ?>">
                                    <a href="?page=data_secunder" class="menu-link">
                                        <i class="menu-icon tf-icons ti ti-smart-home"></i>
                                        <div data-i18n="Secunder">Secunder</div>
                                    </a>
                                </li>
                            </ul>
                        </aside>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end dropdown-styles">
                                                <li>
                                                    <a class="dropdown-item" href="javascript:void(0);"
                                                        data-theme="light">
                                                        <span class="align-middle"><i
                                                                class="ti ti-sun me-2"></i>Light</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="javascript:void(0);"
                                                        data-theme="dark">
                                                        <span class="align-middle"><i
                                                                class="ti ti-moon me-2"></i>Dark</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="javascript:void(0);"
