                ...
                <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                    ...
                    <ul class="menu-inner py-1">
                        ...
                        <li class="menu-item ">
                            ...
                            <ul class="menu-sub">
                                <li class="menu-item active">
                                    <a href="?page=data_user" class="menu-link">
                            ...
                            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                                <div class="app-brand demo">
                                    <a href="index.html" class="app-brand-link">
                                        ...
                                        <span class="app-brand-text demo menu-text fw-bold text-center"> Jhonlin <br> Marine Trans</span>
                                    </a>
                                ...
                                <ul class="menu-inner py-1">
                                    ...
                                    <li class="menu-item <?php if (isset($_GET['page']) && $_GET['page'] == 'public/home.php') echo 'active'; ?>">
                                        <a href="home.php" class="menu-link">
                                    ...
                                    <li class="menu-item <?php if (isset($_GET['page']) && $_GET['page'] == 'data_user') echo 'active'; ?>">
                                        <a href="?page=data_user" class="menu-link">
                                            <i class="menu-icon tf-icons ti ti-users"></i>
                                            <div data-i18n="Users">Users</div>
                                        </a>
                                    ...
                                    <li class="menu-item <?php if (isset($_GET['page']) && ($_GET['page'] == 'data_barge' || $_GET['page'] == 'tambah_barge' || $_GET['page'] == 'edit_barge')) echo 'active'; ?>">
                                        <a href="?page=data_barge" class="menu-link">
                                            <i class="menu-icon tf-icons ti ti-sailboat-off"></i>
                                            <div data-i18n="Barge">Barge</div>
                                        </a>
                                    </li>
                                    <li class="menu-item <?php if (isset($_GET['page']) && ($_GET['page'] == 'data_support' || $_GET['page'] == 'tambah_support' || $_GET['page'] == 'edit_support')) echo 'active'; ?>">
                                        <a href="?page=data_support" class="menu-link">
                                            <i class="menu-icon tf-icons ti ti-sailboat-2"></i>
                                            <div data-i18n="Support">Support</div>
                                        </a>
                                    </li>
                                    <li class="menu-header small text-uppercase">
                                    ...
                                    <li class="menu-item <?php if (isset($_GET['page']) && ($_GET['page'] == 'laporan_tugboat')) echo 'active'; ?>">
                                        <a class="menu-link">
                                            <div type="button" data-bs-toggle="modal" data-bs-target="#exampleModal1">
                                                <i class="menu-icon tf-icons ti ti-report"></i>
                                                <span data-i18n="Laporan Tugboat">Laporan Tugboat</span>
                                            </div>
                                        </a>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Laporan Tugboat</h5>
                                    ...
                                    <li class="menu-item">
                                        <a class="menu-link">
                                            <div type="button" data-bs-toggle="modal" data-bs-target="#exampleModal2">
                                                <i class="menu-icon tf-icons ti ti-report"></i>
                                                <span data-i18n="Sertifikat Tugboat"> Sertifikat Tugboat</span>
                                            </div>
                                        </a>
                                        <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Laporan Sertifikat Tugboat</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                        ...
                                                        <ul class="list-group list-group-flush">
                                                            ...
                                                            <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="flex-grow-1">
                                                                        <h6 class="mb-1">New Message ✉️</h6>
                                                                        <p class="mb-0">You have new message from Natalie
                                                                        </p>
                                                                        <small class="text-muted">1h ago</small>
                                                                    </div>
                                                                    <div class="flex-shrink-0 dropdown-notifications-actions">
                                                            ...
                                                            <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="flex-grow-1">
                                                                        ...
                                                                        <p class="mb-0">Your ABC project application has
                                                                            been approved.
                                                                        </p>
                                                                        <small class="text-muted">2 days ago</small>
                                                                    </div>
                                                            ...
                                                            <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="flex-grow-1">
                                                                        <h6 class="mb-1">Send connection request</h6>
                                                                        <p class="mb-0">Peter sent you connection request
                                                                        </p>
                                                                        <small class="text-muted">4 days ago</small>
                                                                    </div>
                                                                    <div class="flex-shrink-0 dropdown-notifications-actions">
